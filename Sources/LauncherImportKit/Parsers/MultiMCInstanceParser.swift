...
public struct MultiMCInstanceParser: LauncherInstanceParser {
    public let launcherType: ImportLauncherType

    public init(launcherType: ImportLauncherType) {
    ...
    private func extractModLoader(from pack: MMCPack) -> (loader: String, version: String) {
        for component in pack.components {
            ...
            case "net.fabricmc.fabric-loader":
                return (ImportModLoader.fabric.displayName, component.version)
            case "net.minecraftforge":
                return (ImportModLoader.forge.displayName, component.version)
            case "net.neoforged":
                return (ImportModLoader.neoforge.displayName, component.version)
            case "org.quiltmc.quilt-loader":
                return (ImportModLoader.quilt.displayName, component.version)
            default:
                continue
            }
        }
